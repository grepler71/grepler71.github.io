                          ...
                          <div>
                                ...
                                <div>
                                    ...
                                    <form action="submit.php" method="post">
                                            ...
                                            <fieldset class="leftsection">
                                                <legend>Credit Card Information</legend><br>
                                                <div>
                                                    Credit Card Number:<INPUT TYPE="text" NAME="ccnumber" required><br><br>
                                                    Expiration Date:<INPUT TYPE="text" NAME="expdate" required><br><br>
                                                    CVV Code:<INPUT TYPE="text" NAME="cvvcode" required><br><br>
                                             ...
                                             <fieldset class="leftsection">  
                                                ...
                                                <div>
                                                   ...
                                                   Address 1:<input TYPE="text" NAME="address1" required><br><br>
