...
function authorizeCreditCard($ccnumber,$expdate,$cvvcode,$fname,$lname,$addr1,$city,$state,$zip,$email,$amount)
{
    ...
    $creditCard->setCardCode($cvvcode);
   ...
   // $order->setInvoiceNumber("10101");
    ...
    $customerAddress->setAddress($addr1);
